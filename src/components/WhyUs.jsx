...
const WhyUs = () => {
  return (
    <div className="bg-[#31B4C9] md:mx-10 mx-5 rounded-2xl text-white inter text-center py-5 md:py-10 md:px-20">
      ...
      <div className="flex flex-col md:flex-row gap-5 md:gap-0 items-center justify-center mt-5 ml-45 md:ml-0">
        <WhyCard
